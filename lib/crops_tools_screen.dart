// crops_tools_screen.dart
import 'package:flutter/material.dart';

class CropsToolsScreen extends StatefulWidget {
  const CropsToolsScreen({super.key});

  @override
  State<CropsToolsScreen> createState() => _CropsToolsScreenState();
}

class _CropsToolsScreenState extends State<CropsToolsScreen> with SingleTickerProviderStateMixin {
            ...
            child: FadeTransition(
              ...
              child: Column(
                children: [
                  ...
                  // Main Content - Scrollable grid of tools
                  Expanded(
                    child: Container(
