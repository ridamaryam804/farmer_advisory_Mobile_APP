...
class HandToolsScreen extends StatefulWidget {
  const HandToolsScreen({super.key});

  @override
  State<HandToolsScreen> createState() => _HandToolsScreenState();
}

class _HandToolsScreenState extends State<HandToolsScreen> with SingleTickerProviderStateMixin {
